...
import SchedulePlanner from '../components/production/SchedulePlanner';
import BatchTracking from '../components/production/BatchTracking';
import { Plus, BarChart3, Calendar, Package } from 'lucide-react';

const Production: React.FC = () => {
  const quickActions = [
    { label: 'New Work Order', icon: Plus, color: 'bg-blue-500' },
    { label: 'View Schedule', icon: Calendar, color: 'bg-green-500' },
    { label: 'Track Batch', icon: Package, color: 'bg-purple-500' },
    ...
    <div className="space-y-6">
      ...
      <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
        <div className="animate-fade-in-up">
          ...
          <p className="text-gray-500 mt-1">Manage production lines, work orders, and schedules</p>
        </div>
